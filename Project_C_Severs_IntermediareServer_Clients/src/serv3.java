...
public class serv3 {
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(9092)) {
            System.out.println("Server 3 ON ON PORT 9092");
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    while (true) {
                        ...
                        // Register the server with the central server
                        int serverName =3; // Provide the server name
                        String ipAddress = "localhost";// Provide the server IP address
                        String communicationPort = "9092"; // Provide the server communication port
