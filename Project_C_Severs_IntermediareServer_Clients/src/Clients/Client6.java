...
public class Client6 {
    ...
    public static void main(String[] args) {
        try {
            DatagramSocket clientSocket = new DatagramSocket(9881);
            clientSocket.setSoTimeout(5000); // Set timeout to 5 seconds
            InetAddress serverAddress = InetAddress.getByName("localhost");
            int sendPort = 9876; // Send back to Client1
            String[] referenceChain3 = {"S5", "S4", "S1", "S3", "S10", "S7", "S6", "S0", "S13", "S2", "S1", "S7", "S6", "S3", "S15", "S2", "S1", "S14", "S5", "S6", "FIN"};
            int refChainIndex = 0;
            ...
            while (ClientOn) {
            	String message = "\u001B[38;5;206mTOKEN FROM CLIENT 6\u001B[0m";
