...
public class Client5 {
    ...
    public static void main(String[] args) {
        try {
            DatagramSocket clientSocket = new DatagramSocket(9880);
            clientSocket.setSoTimeout(5000); // Set timeout to 5 seconds
            InetAddress serverAddress = InetAddress.getByName("localhost");
            int sendPort = 9881; // Send back to Client1
            String[] referenceChain3 = {"S2", "S14", "S1", "S7", "S6", "S3", "S0", "S5", "S2", "S15", "S7", "S0", "S4", "S12", "S3", "S6", "S7", "S2", "S1", "S13", "FIN"};
            int refChainIndex = 0;
            ...
            while (ClientOn) {
            	String message = "\u001B[38;5;206mTOKEN FROM CLIENT 5\u001B[0m";
