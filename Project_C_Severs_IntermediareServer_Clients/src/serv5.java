...
public class serv5 {
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(9094)) {
            System.out.println("Server 5 ON ON PORT 9094");
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    while (true) {
                        ...
                        // Register the server with the central server
                        int serverName =5; // Provide the server name
                        String ipAddress = "localhost";// Provide the server IP address
                        String communicationPort = "9094"; // Provide the server communication port
