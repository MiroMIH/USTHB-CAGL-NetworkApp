...
public class serv1 {
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(9090)) {
            System.out.println("Server 1 ON ON PORT 9090");
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    while (true) {
                        ...
                        int serverName =1; // Provide the server name
                        String ipAddress = "localhost";// Provide the server IP address
                        String communicationPort = "9090"; // Provide the server communication port
                        ...
                        //print all registeration on serverEJB side for verification
                        //bean.printRegisteredServers();
