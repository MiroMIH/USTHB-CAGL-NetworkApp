...
public class serv2 {
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(9091)) {
            System.out.println("Server 2 ON ON PORT 9091");
            ...
            while (true) {
                try (Socket clientSocket = serverSocket.accept();
                    ...
                    while (true) {
                        ...
                        // Register the server with the central server
                        int serverName =2; // Provide the server name
                        String ipAddress = "localhost";// Provide the server IP address
                        String communicationPort = "9091"; // Provide the server communication port
